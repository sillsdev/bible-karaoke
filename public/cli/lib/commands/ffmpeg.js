   ...
   if (Options.backgroundType === "video") {
      ...
      new Promise((resolve, reject) => {
         ...
         return new Promise((resolve, reject) => {
            ...
            const combinePNGs = new FFMpegProgress(["-framerate", Options.framerateIn, "-i", path.join(Options.images, "frame_%011d.png"), "-vcodec", "ffvhuff", videoAlpha], {
               cmd: ffmpegExe
            });
