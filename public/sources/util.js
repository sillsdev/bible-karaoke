...
class Chapter_SAB {
  constructor(book = '', chapter='', audio = [], segments = []) {
    this.book = book;
...
class segments{
  constructor(segmentId = '', text ='', verse ='', startTime ='', length ='' ){
